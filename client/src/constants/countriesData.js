export const countriesData = {
  ...
  data: [
    ...
    { name: "Aland Islands", iso3: "ALA", iso2: "AX", states: [] },
    {
      name: "Albania",
      iso3: "ALB",
      iso2: "AL",
    ...
    { name: "Anguilla", iso3: "AIA", iso2: "AI", states: [] },
    { name: "Antarctica", iso3: "ATA", iso2: "AQ", states: [] },
    {
    ...
    { name: "Aruba", iso3: "ABW", iso2: "AW", states: [] },
    {
      name: "Australia",
      iso3: "AUS",
      iso2: "AU",
    ...
    { name: "Bouvet Island", iso3: "BVT", iso2: "BV", states: [] },
    {
      name: "Brazil",
      iso3: "BRA",
      iso2: "BR",
    ...
    { name: "Cayman Islands", iso3: "CYM", iso2: "KY", states: [] },
    {
    ...
    { name: "Christmas Island", iso3: "CXR", iso2: "CX", states: [] },
    {
    ...
    { name: "Cook Islands", iso3: "COK", iso2: "CK", states: [] },
    {
      name: "Costa Rica",
      iso3: "CRI",
      iso2: "CR",
    ...
    { name: "Falkland Islands", iso3: "FLK", iso2: "FK", states: [] },
    { name: "Faroe Islands", iso3: "FRO", iso2: "FO", states: [] },
    {
      name: "Fiji Islands",
      iso3: "FJI",
      iso2: "FJ",
    ...
    { name: "French Polynesia", iso3: "PYF", iso2: "PF", states: [] },
    {
    ...
    { name: "Gibraltar", iso3: "GIB", iso2: "GI", states: [] },
    {
      name: "Greece",
      iso3: "GRC",
      iso2: "GR",
    ...
    { name: "Greenland", iso3: "GRL", iso2: "GL", states: [] },
    {
      name: "Grenada",
      iso3: "GRD",
      iso2: "GD",
    ...
    { name: "Guadeloupe", iso3: "GLP", iso2: "GP", states: [] },
    { name: "Guam", iso3: "GUM", iso2: "GU", states: [] },
    {
      name: "Guatemala",
      iso3: "GTM",
      iso2: "GT",
    ...
    { name: "Guernsey", iso3: "GGY", iso2: "GG", states: [] },
    {
      name: "Guinea",
      iso3: "GIN",
      iso2: "GN",
    ...
    { name: "Hong Kong S.A.R.", iso3: "HKG", iso2: "HK", states: [] },
    {
      name: "Hungary",
      iso3: "HUN",
      iso2: "HU",
    ...
    { name: "Jersey", iso3: "JEY", iso2: "JE", states: [] },
    {
      name: "Jordan",
      iso3: "JOR",
      iso2: "JO",
    ...
    { name: "Macau S.A.R.", iso3: "MAC", iso2: "MO", states: [] },
    {
      name: "Macedonia",
      iso3: "MKD",
      iso2: "MK",
    ...
    { name: "Man (Isle of)", iso3: "IMN", iso2: "IM", states: [] },
    {
    ...
    { name: "Martinique", iso3: "MTQ", iso2: "MQ", states: [] },
    {
      name: "Mauritania",
      iso3: "MRT",
      iso2: "MR",
    ...
    { name: "Mayotte", iso3: "MYT", iso2: "YT", states: [] },
    {
      name: "Mexico",
      iso3: "MEX",
      iso2: "MX",
    ...
    { name: "Monaco", iso3: "MCO", iso2: "MC", states: [] },
    {
      name: "Mongolia",
      iso3: "MNG",
      iso2: "MN",
    ...
    { name: "Montserrat", iso3: "MSR", iso2: "MS", states: [] },
    {
      name: "Morocco",
      iso3: "MAR",
      iso2: "MA",
    ...
    { name: "New Caledonia", iso3: "NCL", iso2: "NC", states: [] },
    {
      name: "New Zealand",
      iso3: "NZL",
      iso2: "NZ",
    ...
    },
    {
      ...
      states: [
        ...
        { name: "Akwa Ibom State", state_code: "NG-AK" },
        { name: "Anambra State", state_code: "NG-AN" },
        { name: "Bauchi State", state_code: "NG-BA" },
        { name: "Bayelsa State", state_code: "NG-BY" },
        { name: "Benue State", state_code: "NG-BE" },
        { name: "Borno State", state_code: "NG-BO" },
        { name: "Cross River State", state_code: "NG-CR" },
        { name: "Delta State", state_code: "NG-DE" },
        { name: "Ebonyi State", state_code: "NG-EB" },
        { name: "Edo State", state_code: "NG-ED" },
        { name: "Ekiti State", state_code: "NG-EK" },
        { name: "Enugu State", state_code: "NG-EN" },
        { name: "Federal Capital Territory", state_code: "NG-FC" },
        { name: "Gombe State", state_code: "NG-GO" },
        { name: "Imo State", state_code: "NG-IM" },
        { name: "Jigawa State", state_code: "NG-JI" },
        { name: "Kaduna State", state_code: "NG-KD" },
        { name: "Kano State", state_code: "NG-KN" },
        { name: "Katsina State", state_code: "NG-KT" },
        { name: "Kebbi State", state_code: "NG-KE" },
        { name: "Kogi State", state_code: "NG-KO" },
        { name: "Kwara State", state_code: "NG-KW" },
        { name: "Lagos State", state_code: "NG-LA" },
        { name: "Nasarawa State", state_code: "NG-NA" },
        { name: "Niger State", state_code: "NG-NI" },
        { name: "Ogun State", state_code: "NG-OG" },
        { name: "Ondo State", state_code: "NG-ON" },
        { name: "Osun State", state_code: "NG-OS" },
        { name: "Oyo State", state_code: "NG-OY" },
        { name: "Plateau State", state_code: "NG-PL" },
        { name: "Rivers State", state_code: "NG-RI" },
        { name: "Sokoto State", state_code: "NG-SO" },
        { name: "Taraba State", state_code: "NG-TA" },
        { name: "Yobe State", state_code: "NG-YO" },
        { name: "Zamfara State", state_code: "NG-ZA" },
      ],
    },
    { name: "Niue", iso3: "NIU", iso2: "NU", states: [] },
    { name: "Norfolk Island", iso3: "NFK", iso2: "NF", states: [] },
    {
    ...
    { name: "Pitcairn Island", iso3: "PCN", iso2: "PN", states: [] },
    {
      name: "Poland",
      iso3: "POL",
      iso2: "PL",
    ...
    { name: "Puerto Rico", iso3: "PRI", iso2: "PR", states: [] },
    {
      name: "Qatar",
      iso3: "QAT",
      iso2: "QA",
    ...
    { name: "Réunion", iso3: "REU", iso2: "RE", states: [] },
    {
      name: "Romania",
      iso3: "ROU",
      iso2: "RO",
    ...
    { name: "Saint Helena", iso3: "SHN", iso2: "SH", states: [] },
    {
    ...
    { name: "Saint-Barthelemy", iso3: "BLM", iso2: "BL", states: [] },
    {
    ...
    },
    {
      ...
      states: [
        ...
        { name: "Araba Álava Province", state_code: "VI" },
        ...
        { name: "Biscay Province", state_code: "BI" },
        ...
        { name: "Gipuzkoa Province", state_code: "SS" },
    ...
    { name: "Tokelau", iso3: "TKL", iso2: "TK", states: [] },
    {
      name: "Tonga",
      iso3: "TON",
      iso2: "TO",
    ...
    { name: "Wallis And Futuna", iso3: "WLF", iso2: "WF", states: [] },
    { name: "Western Sahara", iso3: "ESH", iso2: "EH", states: [] },
    {
      name: "Yemen",
      iso3: "YEM",
      iso2: "YE",
...
export const getAllCountries = () => {
  const sortedData = countriesData.data.sort((a, b) =>
