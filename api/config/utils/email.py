...
from sendgrid.helpers.mail import Mail, Attachment, FileContent, FileName, FileType, Disposition, Asm, Category, TrackingSettings, ClickTracking

FROM_EMAIL = "no-reply@tipsbymoh.tech"
...
def send_email(email, params, email_template_id, email_must_be_tracked_by_sg=False):
    try:
        message = Mail(
        ...
        if not email_must_be_tracked_by_sg:
...
def send_email_with_attachment(email, params, attached_file_info, email_template_id, email_must_be_tracked_by_sg=False):
    """
