    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(blank=True, null=True, storage=core.models.base_model.MediaFileS3Storage(bucket_name='media', is_public=True), upload_to=core.utils.helpers.get_media_upload_path)),
                ('file_type', models.CharField(choices=[('IMAGE', 'IMAGE'), ('VIDEO', 'VIDEO'), ('PDF', 'PDF'), ('CSV', 'CSV'), ('AUDIO', 'AUDIO'), ('OTHER', 'OTHER')], max_length=256)),
                ('post_type', models.CharField(choices=[('GENERAL', 'GENERAL')], max_length=256)),
            ],
            options={
                'abstract': False,
            },
